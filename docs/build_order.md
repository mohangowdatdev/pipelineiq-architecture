...
| 9.4 | Bronze → Silver → Gold full run | Pending | — | Databricks Job | End-to-end Phase 2 exit. Bronze layer for all 10 entities done in 9.4b; Silver + Gold notebooks still to be written. |
