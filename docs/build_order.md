...
| 9.4 | Bronze → Silver → Gold full run | In progress | — | Databricks Job | End-to-end Phase 2 exit. Bronze 100% (9.4b); Silver 2/10 (orders, customers); Gold 1/12 (dim_customer). Remaining: 8 Silver tables + 11 Gold dims/facts. |
